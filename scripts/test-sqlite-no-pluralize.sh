...
cd ~/code/demo-sqlite
shadrizz init -p pnpm --latest --db-dialect sqlite -pk uuidv4 --auth-solution authjs --auth-providers github,google,postmark,nodemailer,credentials --admin --no-pluralize
