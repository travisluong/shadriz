...
cd demo-postgresql
shadrizz init -p pnpm --latest --db-dialect postgresql -pk cuid2 --auth-solution authjs --auth-providers github,google,postmark,nodemailer,credentials --admin --pluralize
