...
cd demo-mysql
shadrizz init -p pnpm --latest --db-dialect mysql -pk auto_increment --auth-solution authjs --auth-providers github,google,postmark,nodemailer,credentials --admin
