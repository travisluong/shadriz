...
export class AdminProcessor implements ShadrizProcessor {
  ...
  async render(): Promise<void> {
    ...
    const rolesScaffoldProcessor = new ScaffoldProcessor({
      ...this.opts,
      table: "roles",
      columns: ["name:text"],
      authorizationLevel: "admin",
    ...
    rolesScaffoldProcessor.process();

    const usersRolesScaffoldProcessor = new ScaffoldProcessor({
      ...this.opts,
      table: "users_roles",
      columns: ["user:references_combobox", "roles:references_select"],
      authorizationLevel: "admin",
    });

    usersRolesScaffoldProcessor.process();
