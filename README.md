...
Server actions and components generated by the `scaffold` command will be organized by authorization level and placed into either `admin`, `private`, or `public` folders.
